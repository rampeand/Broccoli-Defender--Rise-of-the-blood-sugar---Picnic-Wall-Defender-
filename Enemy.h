...
class Enemy
{
	...
	bool                    mIsBig;
public:
	Enemy(const Vec2 &pos, const Texture* tex, int hp, const bool isBasic, const bool isFast, const bool isBig);
	~Enemy();
	...
	void                    SetHp(int x)                    { mHealth = x; }

	int                     Hp()                            { return mHealth; }
	bool                    IsBasic()                       { return mIsBasic; }
	bool                    IsFast()                       { return mIsFast; }
